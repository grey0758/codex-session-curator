...
| ny001 | ny001.ip.xiannai.me | 38.246.235.98 | newyork001 | grey | New York 001 host; public SSH verified from local workstation; hk003 cannot reach public 22/443/2222 as of 2026-06-02. NetBird control-plane host also resolves here. The historical `192.3.226.177` compatibility host was provider-refreshed and reassigned to canonical `us001` on 2026-07-17; it is no longer a ny001 access path. |
